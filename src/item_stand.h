...
static void spawn_item_stand(float x, float y,int board_index)
{
...
{
    spawn_item_stand(1232,896,current_board_index);
    spawn_item_stand(1232,912,current_board_index);
    spawn_item_stand(1232,928,current_board_index);
}
